...
$generator = new Generator( "localhost", "root", "", "campusguide_test", Generator::MODE_DAO_STANDARD );
...
$generator->onlyTables = array( "building_navigation_edge", "building_navigation_node" );
