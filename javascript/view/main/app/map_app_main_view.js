// CONSTRUCTOR
MapAppMainView.prototype = new AppMainView();

function MapAppMainView(wrapperId) {
...
MapAppMainView.POSITION_LENGTH_MIN = 0.03; // 30 meters
 ...
 */
MapAppMainView.prototype.getController = function() {
 ...
 * @return {Object}
 */
MapAppMainView.prototype.getPageWrapper = function() {
 ...
 * @return {Object}
 */
MapAppMainView.prototype.getBuildingSliderElement = function() {
 ...
 * @return {Object}
 */
MapAppMainView.prototype.getMenuActionBar = function() {
 ...
 */
MapAppMainView.prototype.getMapBounds = function() {
...
MapAppMainView.prototype.setMapBounds = function(lat, lng, zoom) {
...
MapAppMainView.prototype.doBindEventHandler = function() {
...
MapAppMainView.prototype.doGeolocationInit = function() {
	var context = this;
...
MapAppMainView.prototype.doGeolocationStop = function() {
	if (this.geolocationWatchProcess != null) {
...
MapAppMainView.prototype.doBuildingSlider = function(buildingId) {
	var buildingSlider = this.getWrapperElement().find("#building_slider_wrapper");
...
MapAppMainView.prototype.doPositionSet = function() {
	var context = this;
...
MapAppMainView.prototype.doFitToParent = function() {
	if (this.map)
		$("#map_page_wrapper").hide();
	AppMainView.prototype.doFitToParent.call(this);
...
MapAppMainView.prototype.doActionBarMenu = function(event, menuItem) {
	var context = this;
...
MapAppMainView.prototype.doActionBarMenuClose = function() {
...
MapAppMainView.prototype.handleMapInit = function() {
	var context = this;
...
MapAppMainView.prototype.handleMapLoaded = function() {
	this.mapLoaded = true;
...
MapAppMainView.prototype.handleMapBuildings = function(buildings) {
	var context = this;
...
MapAppMainView.prototype.handleGeolocationError = function(error) {
	switch (error.code) {
...
MapAppMainView.prototype.handleGeolocationQuery = function(position) {
 ...
 *            dataUrl
 */
MapAppMainView.prototype.handleBuildingTakemethere = function(building, dataUrl) {
...
MapAppMainView.prototype.handleBuildingSlide = function() {
 ...
 *            latlng
 */
MapAppMainView.prototype.handlePosition = function(latlng) {
	...
	for (buildingId in this.markerBuildings) {
		...
		if (position) {
			...
			if (distance <= MapAppMainView.POSITION_LENGTH_MIN && ((closestDistance != null && distance < closestDistance) || closestDistance == null)) {
...
MapAppMainView.prototype.handlePositionSet = function(latlng) {
