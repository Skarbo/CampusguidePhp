// CONSTRUCTOR
FacilitiesCmsCampusguideMainView.prototype = new CmsCampusguideMainView();

/**
 * @param {string}
 *            wrapperId Wrapper id
 */
function FacilitiesCmsCampusguideMainView(wrapperId) {
...
FacilitiesCmsCampusguideMainView.SEARCH_DELAY = 500;
...
/**
 * @returns {FacilitiesCmsCampusguideMainController}
 */
FacilitiesCmsCampusguideMainView.prototype.getController = function() {
 ...
 * @returns {Object}
 */
FacilitiesCmsCampusguideMainView.prototype.getSearchInputElement = function() {
 ...
 * @returns {Object}
 */
FacilitiesCmsCampusguideMainView.prototype.getSearchResetButtonElement = function() {
 ...
 * @returns {Object}
 */
FacilitiesCmsCampusguideMainView.prototype.getFacilitiesTableElement = function() {
...
FacilitiesCmsCampusguideMainView.prototype.doBindEventHandler = function() {
...
FacilitiesCmsCampusguideMainView.prototype.doMap = function() {
...
FacilitiesCmsCampusguideMainView.prototype.doSearch = function(search, delay) {
	...
	if (delay != undefined && delay == true) {
		...
		}, FacilitiesCmsCampusguideMainView.SEARCH_DELAY);
		return;
	}
...
FacilitiesCmsCampusguideMainView.prototype.handleFacilitiesCheck = function(checkboxes) {
...
FacilitiesCmsCampusguideMainView.prototype.handleMapBuildings = function(buildings) {
...
FacilitiesCmsCampusguideMainView.prototype.handleFacilityHighlight = function(facilityBodyElement) {
...
FacilitiesCmsCampusguideMainView.prototype.handleBuildingHighlight = function(buildingId) {
...
FacilitiesCmsCampusguideMainView.prototype.after = function() {
 ...
 *            controller
 */
FacilitiesCmsCampusguideMainView.prototype.draw = function(controller) {
