// CONSTRUCTOR
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype = new PresenterView();

function SidebarBuildingcreatorCmsCampusguidePresenterView(view) {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarHeaderElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarFloorsElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarFloorsTableElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarFloorsButtonsElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarFloorsFormElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarFloorsErrorElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarElementsElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarElementsFloorsElement = function() {
 ...
 * @return {Object}
 */
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.getSidebarElementsDeleteElement = function() {
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doBindEventHandler = function() {
	var context = this;
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doFloorsEdit = function(edit) {
	var floorsTable = this.getSidebarFloorsTableElement();
	var floorsButtons = this.getSidebarFloorsButtonsElement();
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doFloorsOrder = function(row, up) {
	// Get floor order
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doFloorsSave = function() {
	var floorsTable = this.getSidebarFloorsTableElement();
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doElementEdit = function(edit, element) {
	if (!element)
		return;
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doElementSave = function(elementElement) {
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.doElementSaved = function(element) {
	if (!element)
		return;
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.handleSelect = function(type, element) {
	// De-select Element
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.handleFloorSelect = function(floorId) {
	if (!floorId)
		return false;
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.handleMenu = function(menu, sidebar) {
...
SidebarBuildingcreatorCmsCampusguidePresenterView.prototype.draw = function(root) {
