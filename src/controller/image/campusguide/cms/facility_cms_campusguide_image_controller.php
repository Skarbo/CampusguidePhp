...
class FacilityCmsCampusguideImageController extends CmsCampusguideImageController
{
    ...
    private function getFacilityImageModified()
    {
        ...
        $facilityImage = Resource::image()->campusguide()->facility()->getFacilityMap(
    ...
    /**
     * @see CmsCampusguideImageController::getImage()
     */
    public function getImage()
    {
        ...
        return Resource::image()->campusguide()->facility()->getDefaultFacilityMap( $width, $height );
    ...
    private function createFacilityMapUrl()
    {
        ...
        for ( $this->getBuildings()->rewind(); $this->getBuildings()->valid(); $this->getBuildings()->next() )
        {
            ...
            {
                $markers[] = $building->getLocation() ? $building->getLocation() : implode( ", ",
        ...
        return Resource::image()->campusguide()->facility()->getUrlFacilityMap( $markers, $width, $height );
    ...
    private function doCacheFacilityImage()
    {
        ...
        $facilityMapFile = Resource::image()->campusguide()->facility()->getFacilityMap(
                $this->getFacility()->getId(), $this->getMode(), $width, $height );
