...
class ElementsBuildingRestController extends StandardRestController
{
    ...
    public function __construct( $api, $view )
    {
        ...
        $this->setElementBuildingHandler(
                new ElementBuildingHandler( $this->getDaoContainer()->getElementBuildingDao(),
                        $this->getDaoContainer()->getSectionBuildingDao(),
    ...
    {
        return $this->getDaoContainer()->getElementBuildingDao();
    }
    ...
    /**
     * @see AbstractStandardRestController::isTouchOnManipulate()
     */
    ...
    /**
     * @see AbstractStandardRestController::doAddCommand()
     */
    ...
    /**
     * @see AbstractStandardRestController::doEditCommand()
     */
