...
class BuildingCampusguideImageResource extends ClassCore
{
    ...
    {
        return self::getBuildingImage( $buildingId, $mode, BuildingCmsCampusguideImageController::$TYPE_OVERVIEW,
                $width, $height );
    }
    ...
    {
        return self::getBuildingDefault( BuildingCmsCampusguideImageController::$TYPE_OVERVIEW, $width, $height );
    }
    ...
    {
        return self::getBuildingImage( $buildingId, $mode, BuildingCmsCampusguideImageController::$TYPE_MAP, $width,
                $height );
    }

    public function getBuildingMapDefault( $width = self::BUILDING_MAP_WIDTH_DEFAULT, $height = self::BUILDING_MAP_HEIGHT_DEFAULT )
    {
        return self::getBuildingDefault( BuildingCmsCampusguideImageController::$TYPE_MAP, $width, $height );
    }
