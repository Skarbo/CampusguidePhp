...
class OverviewBuildingsCmsCampusguidePageMainView extends PageMainView
{
    ...
    /**
     * @var BuildingBuildingsCmsCampusguidePresenterView
     */
    ...
    public function __construct( MainView $view )
    {
        ...
        $this->setBuildingPresenter( new BuildingBuildingsCmsCampusguidePresenterView( $view ) );
    }
    ...
    /**
     * @return BuildingBuildingsCmsCampusguidePresenterView
     */
    ...
    /**
     * @param BuildingBuildingsCmsCampusguidePresenterView $buildingPresenter
     */
    public function setBuildingPresenter( BuildingBuildingsCmsCampusguidePresenterView $buildingPresenter )
    {
    ...
    private function drawHeaderMenuSub( AbstractXhtml $root )
    {
        ...
        //                 Resource::url()->campusguide()->cms()->building()->getDeleteBuildingPage( array ( "%s" ),
        ...
        $edit_button = Xhtml::a( "Edit" )->attr( "data-url",
                Resource::url()->campusguide()->cms()->building()->getEditBuildingPage( "%s",
    ...
    private function drawBuildingsTable( AbstractXhtml $root )
    {
        ...
        BuildingBuildingsCmsCampusguidePresenterView::drawHeader( $header );
        ...
        $table->addContent(
                Xhtml::tfoot( Xhtml::tr( Xhtml::td( "No Buildings" ) ) )->id( self::$ID_BUILDINGS_NONE_TABLE )->class_(
                        $this->getView()->getController()->getBuildings()->size() > 0 ? Resource::css()->campusguide()->cms()->getHide() : "" ) );
