...
class AdminFacilityFacilitiesCmsPageMainView extends AdminCmsPageMainView
{
    ...
    {
        return $this->isActionEdit() ? Resource::url()->cms()->facility()->getEditFacilityPage(
                $this->getFacility()->getId(), $this->getView()->getController()->getMode() ) : Resource::url()->cms()->facility()->getNewFacilityPage(
