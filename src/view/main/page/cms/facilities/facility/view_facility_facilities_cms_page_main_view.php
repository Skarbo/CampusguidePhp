...
class ViewFacilityFacilitiesCmsPageMainView extends AbstractPageMainView
{
    ...
    public function draw( AbstractXhtml $root )
    {
        ...
        $buttonsGui->addContent(
                Xhtml::a( "Edit" )->href(
                        Resource::url()->cms()->facility()->getEditFacilityPage(
    ...
    private function drawBuildings( AbstractXhtml $root )
    {
        ...
        for ( $this->getBuildings()->rewind(); $this->getBuildings()->valid(); $this->getBuildings()->next() )
        {
            ...
            // ... Image
            $img = Xhtml::img()->src(
                    Resource::url()->cms()->building()->getBuildingOverviewImage( $building->getId(), 100, 75,
