...
class ActionbarAppPresenterView extends AbstractPresenterView
{
    ...
    private function drawActionButtons( AbstractXhtml $root )
    {
        ...
        {
            $table->addContent(
                    AbstractXhtml::get_( $actionButton )->addClass( Resource::css()->getCenter(), Resource::css()->app()->getTouch() )->style(
