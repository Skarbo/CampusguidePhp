...
abstract class StandardRestView extends AbstractRestView
{
    ...
    {
        return StandardRestController::isEditCommand() || StandardRestController::isAddCommand() || StandardRestController::isRemoveCommand();
    }
